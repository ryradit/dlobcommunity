...
// --- Main Hero Component ---
const TOTAL_IMAGES = 15; // Updated to match available portrait images
...
const IMAGES = [
  ...
  '/images/potrait/IMG_2631.jpg',
  '/images/potrait/IMG_7627.JPG',
  '/images/potrait/IMG_7631.JPG',
  '/images/potrait/IMG_7635.JPG',
  '/images/potrait/IMG_7800.JPG',
  '/images/potrait/IMG_8028.JPG',
  '/images/potrait/IMG_8861.JPG',
  '/images/potrait/IMG_8865.JPG',
  '/images/potrait/IMG_8873.JPG',
];
    ...
    <div ref={containerRef} className="relative w-full h-screen bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
        ...
        <motion.div
          ...
          className="absolute top-[10%] z-10 flex flex-col items-center justify-center text-center pointer-events-auto px-4"
        >
          <h2 className="text-3xl md:text-5xl font-semibold text-gray-900 tracking-tight mb-4">
            Koleksi Foto Terbaik
          </h2>
          <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed mb-8">
            Saksikan momen-momen terbaik dari pertandingan dan latihan badminton kami. <br className="hidden md:block" />
            Setiap foto menceritakan kisah dedikasi dan semangat tim.
          </p>
          <Link
            href="/galeri"
            className="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors duration-300"
          >
            Lihat Selengkapnya
          </Link>
        </motion.div>
