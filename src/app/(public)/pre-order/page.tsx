...
export default function PreOrderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Convert color value to match API expectations (biru, pink, kuning)
    const colorMap: { [key: string]: string } = {
      'biru': 'biru',
      'pink': 'pink',
      'kuning': 'yellow'  // API expects 'yellow' for kuning
    };

    const orderPayload = {
      nama: formData.nama,
      ukuran: formData.ukuran,
      warna: colorMap[formData.warna] || formData.warna,  // Use the API color mapping
    ...
    try {
      console.log('Submitting pre-order with payload:', orderPayload);
      ...
      if (contentType && contentType.includes('application/json')) {
        ...
        responseData = { error: `Server returned non-JSON response: ${text}` };
      }

      if (!response.ok) {
        const errorMessage = responseData?.error || responseData?.details || responseData?.message || `Server error (${response.status})`;
      ...
      console.log('Pre-order submission successful:', responseData);
      ...
      alert(`Terjadi kesalahan: ${errorMessage}\n\nBuka Developer Console (F12) untuk detail lebih lanjut.`);
    } finally {
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-xl p-8">
            ...
            <button
              ...
              className="bg-linear-to-r from-purple-600 to-sky-600 hover:shadow-lg text-white font-medium py-3 px-8 rounded-xl transition-all duration-300"
            >
              Kembali ke Beranda
            </button>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-3 bg-amber-50 border border-amber-300 rounded-xl px-5 py-4 mb-8">
            ...
            <div>
              <p className="font-semibold text-amber-800 text-sm">Informasi Penting Sebelum Pre-Order</p>
              <p className="text-amber-700 text-sm mt-0.5">
                Pesanan jersey akan mulai <span className="font-bold">diproses & diproduksi</span> setelah kuota minimum <span className="font-bold">15 order</span> terpenuhi. Kami akan menghubungi Anda via WhatsApp untuk konfirmasi ketika produksi dimulai. 🏸
              </p>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">15 Februari 2026</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 shrink-0"></div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Setelah Lebaran</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Milano Standard Premium</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <a
                  ...
                  className="w-full bg-linear-to-r from-pink-600 to-yellow-500 hover:shadow-lg text-white font-medium py-3 px-4 rounded-xl flex items-center justify-center space-x-2 transition-all duration-300"
                >
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="flex-1 bg-linear-to-r from-purple-600 to-sky-600 hover:shadow-lg text-white font-medium py-3 px-4 rounded-xl transition-all duration-300"
                >
                  Sudah Transfer
                </button>
              </div>
