    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 px-4 lg:px-8 py-6 lg:py-8 transition-colors duration-300">
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">Analitik Pertandingan</h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-zinc-300 font-medium">Statistik lengkap dan riwayat pertandingan Anda</p>
          </div>
      ...
      <div className="member-analitik-charts grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        {scoreProgression.length > 0 && (
          <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm transition-colors duration-300">
            ...
            <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium mb-4">20 Pertandingan Terakhir</p>
        ...
        {formTrend.length > 0 && (
          <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm transition-colors duration-300">
            ...
            <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium mb-4">Rolling Average (10 Match)</p>
            <ResponsiveContainer width="100%" height={320}>
      ...
      <div className="member-analitik-partners grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm transition-colors duration-300">
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-500 dark:text-zinc-400 mt-1 font-medium leading-normal">
      ...
      <div className="member-analitik-filter bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 mb-6 shadow-sm transition-colors duration-300">
        ...
        {showFilters && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm text-gray-600 dark:text-zinc-400 font-semibold mb-2">Tanggal Mulai</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-zinc-400 font-semibold mb-2">Tanggal Akhir</label>
              <input
                type="date"
                value={dateRange.end}
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-zinc-400 font-semibold mb-2">Partner</label>
              <select
        ...
        {hasActiveFilters && (
          <div className="mt-4 flex items-center gap-2">
            ...
            <button
              ...
              className="text-sm text-red-600 dark:text-red-400 hover:text-red-500 dark:hover:text-red-300 flex items-center gap-1 font-medium"
            >
              <X className="w-4 h-4" />
              Clear Filters
            </button>
      ...
      <div className="member-analitik-match-history bg-white dark:bg-zinc-900 border border-gray-200/80 dark:border-zinc-800/80 rounded-2xl p-6 transition-all duration-300 shadow-xs hover:shadow-sm hover:border-indigo-400/40 dark:hover:border-zinc-700">
        ...
        {loading ? (
          <div className="h-64 flex items-center justify-center text-gray-500 dark:text-zinc-400">
      ...
      {showAIHelpModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-zinc-900 border border-purple-300 dark:border-purple-500/30 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-linear-to-r from-purple-100/80 dark:from-purple-900/50 to-blue-100/80 dark:to-blue-900/50 border-b border-purple-200 dark:border-purple-500/30 p-6">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <ol className="space-y-3 text-gray-600 dark:text-zinc-300">
                  <li className="flex gap-3">
                    <span className="shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-400 flex items-center justify-center text-sm font-semibold">1</span>
                    <span><strong className="text-gray-900 dark:text-white">Pengumpulan Data:</strong> Sistem mengumpulkan semua data pertandingan Anda (win rate, streak, skor, partner, lawan)</span>
                  </li>
                  <li className="flex gap-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span><strong className="text-gray-900 dark:text-white">Insight Personal:</strong> AI menghasilkan 3-4 wawasan spesifik dengan bahasa yang motivatif dan mudah dipahami</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-400 flex items-center justify-center text-sm font-semibold">4</span>
                    <span><strong className="text-gray-900 dark:text-white">Caching Cerdas:</strong> Hasil disimpan untuk menghindari analisis berulang kecuali ada perubahan data</span>
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-100 dark:bg-zinc-800/50 rounded-lg p-4 space-y-3">
                  ...
                  <p className="text-gray-600 dark:text-zinc-300">
                    <strong className="text-gray-900 dark:text-white">3. Baca insight yang muncul</strong> - setiap kartu berwarna menunjukkan aspek berbeda:
                  </p>
                  <ul className="ml-4 space-y-2 text-sm text-gray-500 dark:text-zinc-400">
                    <li className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-green-500/50"></div>
                      <span><strong className="text-green-700 dark:text-green-400">Hijau:</strong> Kekuatan dan pencapaian positif</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-red-500/50"></div>
                      <span><strong className="text-red-700 dark:text-red-400">Merah:</strong> Area yang perlu perbaikan atau perhatian</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-blue-500/50"></div>
                      <span><strong className="text-blue-700 dark:text-blue-400">Biru:</strong> Informasi netral dan rekomendasi strategis</span>
                    </li>
                  </ul>
                  <p className="text-gray-600 dark:text-zinc-300">
                    <strong className="text-gray-900 dark:text-white">4. Terapkan saran</strong> yang diberikan AI untuk meningkatkan performa Anda!
                  </p>
                </div>
              </div>

              {/* Tips */}
              <div className="bg-purple-50 dark:bg-linear-to-br dark:from-purple-500/10 dark:to-blue-500/10 border border-purple-200 dark:border-purple-500/30 rounded-lg p-4">
