      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" data-tutorial="spotlight-cards">
          {[
            ...
            <div key={card.label} className={`rounded-2xl p-4 border border-gray-200 dark:border-zinc-800/50 shadow-sm ${card.bg} transition-colors duration-300`}>
        ...
        {/* ── Category tabs ────────────────────────────────────────────────── */}
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800/50 shadow-sm overflow-hidden transition-colors duration-300" data-tutorial="leaderboard-panel">
        ...
        {/* ── Full member table ─────────────────────────────────────────────── */}
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800/50 shadow-sm overflow-hidden transition-colors duration-300" data-tutorial="rekap-table">
