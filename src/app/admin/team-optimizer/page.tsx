  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 px-4 lg:px-8 py-6 lg:py-8 transition-colors duration-300">
      <div className="space-y-6">
        ...
        {/* Configuration */}
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 space-y-6 border border-gray-200 dark:border-zinc-800/50 shadow-sm transition-colors duration-300">
          {/* Quick Setup Toggle - TIER 3E */}
          <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-300 dark:border-blue-500/30">
            <input
              type="checkbox"
          ...
          {quickSetupMode ? (
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-blue-300 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/5 rounded-lg p-4 space-y-3">
                    ...
                    return (
                      <div key={idx} className="bg-white dark:bg-zinc-900 rounded-xl p-6 border-2 border-gray-300 dark:border-transparent shadow-sm transition-colors duration-300">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="text-center p-3 bg-blue-100 dark:bg-blue-500/10 border border-blue-300 dark:border-blue-500/30 rounded-lg transition-colors duration-300">
