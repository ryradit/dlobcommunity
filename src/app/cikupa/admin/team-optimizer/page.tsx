    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-zinc-900/80 backdrop-blur-md border border-white/10 p-5 rounded-2xl">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-1.5 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-bold rounded-xl border border-white/10 transition-colors self-start md:self-auto"
        >
        ...
        {[
          ...
          return (
            ...
            >
              ...
              <p className="text-xs font-bold text-white mb-0.5">{m.title}</p>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2.5 py-1 text-xs font-semibold text-zinc-400 hover:text-white transition-colors"
            >
              Pilih Semua
            </button>
            <button
