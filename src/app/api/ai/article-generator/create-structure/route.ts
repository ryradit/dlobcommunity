...
2. KOMUNITAS/EVENT/HARI RAYA: Tentang acara DLOB, gathering, sosialisasi, event komunitas, atau perayaan hari besar/hari raya (seperti Idul Adha, Ramadan, dll).
   - JIKA acara badminton/gathering biasa: WAJIB pemain badminton/lapangan DLOB.
   - JIKA acara hari besar/hari raya (Idul Adha, Ramadan, dll): Boleh menampilkan visual yang relevan dengan hari raya tersebut (misal: kambing/domba kurban yang sehat, masjid, suasana berbagi makanan kurban, dll).
...
- Makanan jika artikel BUKAN fokus nutrisi/hari raya (hanya menyebut "protein" tidak cukup)
- Abstract atau umum yang tidak spesifik
- Wajah tanpa konteks badminton/hari raya (portrait random)
- Olahraga outdoor yang bukan badminton

✅ WAJIB GUNAKAN:
- Badminton court dengan shuttlecock dan racket (untuk topik badminton)
- Player dengan DLOB jersey (black/white/blue) (untuk topik badminton/latihan)
- Indoor sports facility yang spesifik badminton
- Visual hari raya/kurban yang relevan (seperti kambing/domba kurban yang sehat, masjid) jika artikel tentang perayaan hari besar
...
2. ARTIKEL KOMUNITAS/EVENT/SILATURAHMI/HARI RAYA:
   RULE: Focus pada pemain badminton, lapangan, gathering moment, ATAU visual hari besar yang dirayakan komunitas.
   - JIKA event komunitas biasa:
   ...
   - JIKA perayaan hari besar/hari raya (seperti Idul Adha/Ramadan):
     * Hero: "Professional photography of Eid al-Adha theme with elegant mosque background, warm community sharing atmosphere"
     * Body: "A clean professional photo of healthy sacrificial sheep and goats in a clean farm pen, soft natural lighting" or "Indonesian community members smiling and sharing packages of meat during Eid al-Adha, warm lighting"
     * CTA: "A clean and inspiring vector illustration of Eid al-Adha greeting with mosque silhouette and crescent moon, warm colors"
   NO UNRELATED SPORTS! No cycling, no running, no soccer!
