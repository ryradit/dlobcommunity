...
export default function PreOrderPage() {
  ...
  const ukuranOptions = ['S', 'M', 'L', 'XL', 'XXL', '3XL'];
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {warnaOptions.map((warna) => (
                          <button
                            ...
                            type="button"
                            onClick={() => handleSelectChange('warna', warna.value)}
                            className={`relative aspect-3/4 overflow-hidden bg-gray-100 border-2 transition-all rounded-lg ${
                          ...
                          >
                            ...
                            <button
                              ...
                              className="absolute top-2 right-2 bg-white bg-opacity-90 hover:bg-white text-black p-1 rounded text-xs font-medium transition-colors"
                            >
                              👁️
                            </button>
                          </button>
