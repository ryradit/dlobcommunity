          ...
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="flex items-center px-3 py-2 text-sm bg-gradient-to-r from-pink-600 to-yellow-500 text-white rounded-lg hover:shadow-lg transition-all duration-300"
              >
                <Plus className="h-4 w-4 mr-1" />
                Add Requirement
              </button>
              <button className="flex items-center px-3 py-2 text-sm bg-gradient-to-r from-purple-600 to-sky-600 text-white rounded-lg hover:shadow-lg transition-all duration-300">
                                  ...
                                  <div key={idx} className="bg-orange-100 p-3 rounded-lg flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2 ml-3">
                                      ...
                                      <button
                                        ...
                                        className="flex items-center px-1 py-1 bg-gradient-to-r from-purple-600 to-sky-600 text-white text-xs rounded hover:shadow-lg transition-all duration-300 mr-1"
                                      ...
                                      <button
                                        ...
                                        className="flex items-center px-1 py-1 bg-gradient-to-r from-yellow-500 to-sky-600 text-white text-xs rounded hover:shadow-lg transition-all duration-300 mr-1"
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  {group.sessionPayment && isConvertibleToMembership(group.sessionPayment) && (
                                    <button
                                      ...
                                      className="flex items-center px-3 py-1.5 bg-gradient-to-r from-purple-600 to-sky-600 text-white text-xs rounded-md hover:shadow-lg transition-all duration-300"
                                  ...
                                  {group.membershipPayment && group.membershipPayment.status === 'pending' && (
                                    <button
                                      ...
                                      className="flex items-center px-3 py-1.5 bg-gradient-to-r from-pink-600 to-yellow-500 text-white text-xs rounded-md hover:shadow-lg transition-all duration-300"
                                ...
                                return (
                                  <>
                                    ...
                                    <button
                                      ...
                                      className="flex items-center px-4 py-2 bg-gradient-to-r from-pink-600 to-yellow-500 text-white text-sm font-medium rounded-lg hover:shadow-lg transition-all duration-300"
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-pink-600 to-yellow-500 text-white rounded-lg hover:shadow-lg transition-all duration-300"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-purple-600 to-sky-600 text-white rounded-lg hover:shadow-lg transition-all duration-300"
              >
