                    ...
                    <div key={member.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="flex items-center px-3 py-1 text-sm bg-gradient-to-r from-yellow-500 to-sky-600 text-white rounded hover:shadow-lg transition-all duration-300"
                        >
