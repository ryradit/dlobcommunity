      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-3 p-3 bg-white rounded border">
              ...
              <div className="mt-3 flex justify-end">
                <button
                  ...
                  className="px-3 py-1 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-sky-600 rounded hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
        ...
        <div className="pt-6 border-t border-gray-200">
          <button
            ...
            className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-sky-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
          >
            {loading ? (
              <div className="flex items-center">
