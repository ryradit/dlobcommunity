                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {payment.status === 'pending' && (
                      <button className="mt-2 flex items-center px-3 py-1 text-xs bg-gradient-to-r from-purple-600 to-sky-600 text-white rounded hover:shadow-lg transition-all duration-300">
                ...
                {payment.status === 'partial' && (
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <button className="flex items-center px-3 py-1 text-xs bg-gradient-to-r from-purple-600 to-sky-600 text-white rounded hover:shadow-lg transition-all duration-300">
                        <CreditCard className="h-3 w-3 mr-1" />
                        Pay Balance
                      </button>
                    </div>
                ...
                {payment.status === 'overdue' && (
                  <div className="mt-4 p-3 bg-red-50 rounded-lg">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <button className="flex items-center px-3 py-1 text-xs bg-gradient-to-r from-pink-600 to-yellow-500 text-white rounded hover:shadow-lg transition-all duration-300">
                        <CreditCard className="h-3 w-3 mr-1" />
                        Pay Now
                      </button>
                    </div>
