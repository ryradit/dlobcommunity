              ...
              {todayAttended ? (
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={checkingIn}
                    className="w-full bg-gradient-to-r from-purple-600 to-sky-600 text-white py-3 px-4 rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                  >
                  ...
                  <button
                    ...
                    disabled={checkingIn}
                    className="w-full bg-gradient-to-r from-pink-600 to-yellow-500 text-white py-3 px-4 rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    disabled={checkingIn}
                    className="w-full bg-gradient-to-r from-yellow-500 to-sky-600 text-white py-3 px-4 rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                  >
