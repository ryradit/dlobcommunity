              ...
              <div className="border-t border-gray-200 p-4">
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-sky-600 text-white px-6 py-2 rounded-lg hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center"
                  >
