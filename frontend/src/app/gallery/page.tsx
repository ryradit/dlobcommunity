      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 text-center border-b border-gray-200 pb-8">
          ...
          <Button
            ...
            className={`flex items-center gap-2 ${activeFilter === 'all' ? 'bg-indigo-600 text-white' : 'border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
          >
          ...
          <Button
            ...
            className={`flex items-center gap-2 ${activeFilter === 'matches' ? 'bg-indigo-600 text-white' : 'border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
          >
          ...
          <Button
            ...
            className={`flex items-center gap-2 ${activeFilter === 'training' ? 'bg-indigo-600 text-white' : 'border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
          >
          ...
          <Button
            ...
            className={`flex items-center gap-2 ${activeFilter === 'sparring' ? 'bg-indigo-600 text-white' : 'border border-gray-300 text-gray-700 hover:bg-gray-50'}`}
          >
        ...
        {isLoading ? (
          <div className="flex justify-center items-center py-12">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-400">{text[language].loadingVideos}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredItems.map((item) => (
              <div
                key={item.id}
                className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-indigo-300 hover:shadow-md transition-all duration-300 cursor-pointer group shadow-sm"
                onClick={() => {
                  if (item.type === 'video') {
                    openVideoModal(item);
        ...
        >
          <div className="relative w-full max-w-7xl aspect-video bg-black rounded-lg overflow-hidden shadow-2xl">
            ...
            <button
              ...
              className="absolute top-4 right-4 z-10 bg-white hover:bg-white/90 text-black rounded-full p-2 transition-colors"
