    ...
    <div className={className}>
      ...
      {!showAll && (
        <div className="text-center mt-8">
          <a
            href="/hall-of-fame"
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-sky-600 hover:shadow-xl text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg"
          >
