          ...
          <div className="p-4 bg-white border-t border-gray-100">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-sky-600 text-white p-2 rounded-full hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
              >
