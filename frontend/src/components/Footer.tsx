        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start space-x-3">
                <MessageCircle className="h-4 w-4 mt-0.5 text-white shrink-0" />
                <div>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2 text-sm">
                <a href="https://www.instagram.com/dlob.channel/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
                  <Instagram className="h-4 w-4 shrink-0" />
                  <span>@dlob.channel</span>
                </a>
                <a href="https://www.tiktok.com/@dlobchannel" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
                  <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                  </svg>
                  <span>@dlobchannel</span>
                </a>
                <a href="https://www.youtube.com/@dlobchannel" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start space-x-3">
                <Calendar className="h-4 w-4 mt-0.5 text-white shrink-0" />
                <div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="/hall-of-fame" className="block text-gray-400 hover:text-white transition-colors">
                Hall of Fame
              </a>
              <a href="/gallery" className="block text-gray-400 hover:text-white transition-colors">
                Gallery
              </a>
              <a href="/store" className="block text-gray-400 hover:text-white transition-colors">
                Store
              </a>
            </div>
